...
/**
 * the container activity for {@link LibUIFragment}.
 * verion 0.1.4
 */
public abstract class LibUIFragmentActivity extends RxAppCompatActivity implements IUseEventBus {
    private static final String TAG = "LibUIFragmentActivity";
    ...
    public void onBackPressed() {
        LibUIFragment fragment = getCurrentFragment();
        if (fragment != null) {
     ...
     */
    public LibUIFragment getCurrentFragment() {
        return (LibUIFragment) getSupportFragmentManager().findFragmentById(getContextViewId());
    }
     ...
     */
    public int startFragmentAndDestroyCurrent(final LibUIFragment fragment, final boolean useNewTransitionConfigWhenPop) {
        final LibUIFragment.TransitionConfig transitionConfig = fragment.onFetchTransitionConfig();
    ...
    public int startFragment(LibUIFragment fragment) {
        Log.i(TAG, "startFragment");
        LibUIFragment.TransitionConfig transitionConfig = fragment.onFetchTransitionConfig();
        String tagName = fragment.getClass().getSimpleName();
    ...
    public void popBackStack() {
        ...
        if (getSupportFragmentManager().getBackStackEntryCount() <= 1) {
            ...
            if (toExec != null) {
                if (toExec instanceof LibUIFragment) {
                    LibUIFragment mFragment = (LibUIFragment) toExec;
     ...
     */
    public void popBackStack(Class<? extends LibUIFragment> clazz) {
     ...
     * @param clazz the type of fragment
     */
    public void popBackStackInclusive(Class<? extends LibUIFragment> clazz) {
